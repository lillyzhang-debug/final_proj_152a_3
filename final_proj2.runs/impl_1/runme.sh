...
HD_PWD='C:/Users/Student/Desktop/Group13/final_project_2/final_project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log score_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source score_top_module.tcl -notrace
