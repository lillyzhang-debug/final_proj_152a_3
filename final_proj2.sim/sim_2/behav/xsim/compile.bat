...
REM
REM Generated by Vivado on Mon Dec 01 20:13:12 -0800 2025
...
echo "xvlog --incr --relax -prj rng_tb_vlog.prj"
call xvlog  --incr --relax -prj rng_tb_vlog.prj -log xvlog.log
